...
namespace LunchBlog.Controllers
{
    public class ExperiencesController : Controller
    {
        ...
        public ExperiencesController(LunchBlogDBContext context)
        {
            _context = context;    
        }
        ...
        {
            var lunchBlogDBContext = _context.Experiences.Include(e => e.Location);
        ...
        public async Task<IActionResult> Create([Bind("ExperienceId,Name,Description,Date,LocationId")] Experience experience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExperienceId,Name,Description,Date,LocationId")] Experience experience)
        {
