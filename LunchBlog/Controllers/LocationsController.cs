...
namespace LunchBlog.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public LocationsController(LunchBlogDBContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("LocationId,Name,Address,Price")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocationId,Name,Address,Price")] Location location)
        {
